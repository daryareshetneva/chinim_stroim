...
class ItRocks_Form_Decorator_RegisterPhone extends Zend_Form_Decorator_Abstract {
    ...
    protected $_format = '
        <div class="row">
	        <div class="form-group">
	           <div class="col-md-12">
		           <label>%s</label>
		           <input type="text" value="%s" name="%s" class="form-control input-lg" placeholder="%s" id="%s">
                   %s
 	           </div>
	       </div>
	    </div>
    ...
    public function render($content) {
        ...
        $inputId = $element->getAttrib('inputId');
