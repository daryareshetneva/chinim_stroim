...
class ItRocks_Form_Decorator_DynamicValidationText extends Zend_Form_Decorator_Abstract {
    ...
    public function render($content) 
    {
        ...
        $onhanges = array();
        $onchanges[] = ($this->_formName != null) ? "onchange=\"validation('{$this->_formName}', this)\"": "";
