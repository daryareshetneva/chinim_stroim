...
return array(
    ...
    "A record matching '%value%' was found" => "Запись с ЧПУ '%value%' существует. Придумайте другой вариант или переименуйте существующую запись.",
    "'%value%' is not a valid email address in the basic format local-part@hostname" => "Значение '%value%' некорректно. Укажите электронную почту."
);